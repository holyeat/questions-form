        ...
        <div className="form__group">
                       ...
                       { this.props.config.variants.map((variant) => {
                            return <div className="from__group-radio">
                                ...
                                <input onChange={this.handleChange} value={variant.value ?? ''} style={(variant.showMyVariant !== undefined && variant.showMyVariant !== false) ? {"display":'block'} : {'display': 'none'}} type="text" placeholder={window.constantsOn ? "FRONTFORM_MYVARIANT" : window.constants["FRONTFORM_MYVARIANT"]}/>
